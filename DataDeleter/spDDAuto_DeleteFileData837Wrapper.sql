IF OBJECT_ID('dbo.spDDAuto_DeleteFileData837Wrapper') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDDAuto_DeleteFileData837Wrapper AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDDAuto_DeleteFileData837Wrapper
...
***************************************************************************************************
EXEC spDDAuto_DeleteFileData837Wrapper 'filename'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDDAuto_DeleteFileData837Wrapper
...
IF ISNULL(@action, '') = 'List Files'
	BEGIN
		EXEC spDDAuto_DeleteFileData837 @file_name, @action, @email_address, @build_id, @job_name
		GOTO CLEANUP
	END
