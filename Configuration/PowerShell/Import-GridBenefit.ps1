<#
    ...
    .SYNOPSIS
        ...
        This script saves the benefit data, that was selected, from the Benefit Grid
...
begin
{
    ...
    try
    {
        ...
        $sql_command.CommandText = "dbo.spConfig_GridSaveBenefit"
        ...
        $sql_command.Parameters.Add("@benefit_status", [Data.SQLDBType]::VarChar, 20) >> $null
    }
    catch
    {
        Write-Host $_
...
process
{
    ...
    try
    {
        ...
        $sql_command.Parameters["@benefit_status"].Value = $BenefitStatus
