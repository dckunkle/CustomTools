<#
    ...
    EXAMPLE
    .\Output-FileDeleterLog.ps1 -Server "aldqrdb09" -TypeId 30 
...
$SQLCommand.CommandText = "SELECT * FROM FDLogTypeDetail WHERE type_id=" + $TypeId + " ORDER BY record_id"
