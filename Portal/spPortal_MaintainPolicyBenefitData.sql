/**************************************************************************************************
Name:       spPortal_MaintainPolicyBenefitData
...
EXEC spPortal_MaintainPolicyBenefitData 1262
***************************************************************************************************/
CREATE OR ALTER PROCEDURE dbo.spPortal_MaintainPolicyBenefitData
      (@days		INT	= 30
	  ,@log_id		INT	= 999)
AS
BEGIN
...
DECLARE @category			VARCHAR(20)			= 'PolicyBenefit'
       ,@sql				VARCHAR(8000)
...
INSERT INTO #table_deletes (table_name, check_ids) VALUES ('POLICY_BENEFIT_PB_GROUP', 1)
INSERT INTO #table_deletes (table_name, check_ids) VALUES ('POLICY_BENEFIT_REGION', 1)
INSERT INTO #table_deletes (table_name, check_ids) VALUES ('POLICY_RIDER', 1)
