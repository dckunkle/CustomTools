...
***************************************************************************************************
EXEC spDCAuto_CreateGlobalValues '100-Config%', 22, 'GlobalValues'
***************************************************************************************************/
...
DECLARE @iEntity                            VARCHAR(50)
       ...
       ,@iFFMBaselineMemberIDPointer        VARCHAR(50)
...
CREATE TABLE #Global_Populate
	  ...
	  ,ProviderMatchingServiceEnabled		CHAR(1)			-- SP40
...
SELECT SearchID
      ...
      ,ISNULL([ImportExport_FFMBaselineMemberIDPointer], '')
