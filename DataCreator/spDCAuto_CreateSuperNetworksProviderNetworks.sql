IF OBJECT_ID('dbo.spDCAuto_CreateSuperNetworksProviderNetworks') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDCAuto_CreateSuperNetworksProviderNetworks AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDCAuto_CreateSuperNetworksProviderNetworks
Purpose:    Create supernetworksprovidernetworks data from CorderAutomation
Method:     SuperNetworksProviderNetworks
Screen GID: 111
...
***************************************************************************************************
EXEC spDCAuto_CreateSuperNetworksProviderNetworks '100-Config%', 22, 'SuperNetworksProviderNetworks'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDCAuto_CreateSuperNetworksProviderNetworks
...
--*************************************************************************************************
IF OBJECT_ID('tempdb.dbo.#SuperNetworksProviderNetworks') IS NOT NULL
	DROP TABLE #SuperNetworksProviderNetworks

CREATE TABLE #SuperNetworksProviderNetworks
      (SearchID                              VARCHAR(200)
      ,i_entity_name                         VARCHAR(50)       DEFAULT('ProviderNet_To_SuperNet')
...
--*************************************************************************************************
INSERT INTO #SuperNetworksProviderNetworks
      (SearchID
      ,i_Network_Id
      ,i_effective_date
	  ,i_termination_date
...
SELECT SearchID
      ...
      ,ISNULL([RecordID], '')
      ,ISNULL([gid], '')
  FROM COREAUTO.CoreAutomation.dbo.TD_SuperNetworksProvNetworks
...
-- Update the user
--*************************************************************************************************
UPDATE #SuperNetworksProviderNetworks
   SET iUserID  = @user

--*************************************************************************************************
-- Create the data
--*************************************************************************************************
DECLARE SuperNetworksProviderNetworks_Cursor CURSOR FOR
 SELECT SearchID
       ,i_entity_name
       ...
       ,record_id
       ,static_gid
   FROM #SuperNetworksProviderNetworks

   OPEN SuperNetworksProviderNetworks_Cursor
  FETCH NEXT FROM SuperNetworksProviderNetworks_Cursor
   INTO @SearchID
       ,@i_entity_name
       ,@i_Network_Search_gid
       ,@i_Network_gid
...
CLOSE SuperNetworksProviderNetworks_Cursor
DEALLOCATE SuperNetworksProviderNetworks_Cursor
