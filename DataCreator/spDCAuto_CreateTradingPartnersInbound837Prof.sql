IF OBJECT_ID('dbo.spDCAuto_CreateTradingPartnersInbound837Prof') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDCAuto_CreateTradingPartnersInbound837Prof AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDCAuto_CreateTradingPartnersInbound837Prof
Purpose:    Create tradingpartnersinbound837prof data from CorderAutomation
Method:     TradingPartnersInbound837Prof
Screen GID: 9501
...
***************************************************************************************************
EXEC spDCAuto_CreateTradingPartnersInbound837Prof '100-Config%', 22, 'TradingPartnersInbound837Prof'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDCAuto_CreateTradingPartnersInbound837Prof
...
DECLARE @i_entity_name                VARCHAR(50)
       ...
       ,@i_Key_Transaction_type       VARCHAR(80)
       ,@i_Key_Direction              VARCHAR(20)
       ,@i_Trxn_SID                   VARCHAR(50)
       ,@i_Key_5                      VARCHAR(50)
       ,@i_Key_6                      VARCHAR(80)
       ,@i_key_7_field                VARCHAR(50)
       ,@i_key_8_field                VARCHAR(80)
       ...
       ,@i_non_par_price_var_bypass_2 VARCHAR(20)
       ,@i_non_par_loc_3              VARCHAR(10)
       ,@i_non_par_value_3            VARCHAR(80)
       ,@i_non_par_price_var_bypass_3 VARCHAR(80)
       ,@i_non_par_loc_4              VARCHAR(50)
       ,@i_non_par_value_4            VARCHAR(10)
       ,@i_non_par_price_var_bypass_4 VARCHAR(50)
       ,@i_non_par_loc_5              VARCHAR(80)
       ,@i_non_par_value_5            VARCHAR(50)
       ,@i_non_par_price_var_bypass_5 VARCHAR(20)
       ,@i_non_par_price_state_5      VARCHAR(20)
       ,@iK3Mapped                    VARCHAR(20)
...
--*************************************************************************************************
IF OBJECT_ID('tempdb.dbo.#TradingPartnersInbound837Prof') IS NOT NULL
	DROP TABLE #TradingPartnersInbound837Prof

CREATE TABLE #TradingPartnersInbound837Prof
      (SearchID                     VARCHAR(200)
      ,i_entity_name                VARCHAR(50)       DEFAULT('837P_Inbound')
      ,i_Trading_partner_gid        VARCHAR(50)       DEFAULT('0')
      ,i_Key_Transaction_type       VARCHAR(80)       DEFAULT('837P')
      ,i_Key_Direction              VARCHAR(20)       DEFAULT('I')
      ,i_Trxn_SID                   VARCHAR(50)       DEFAULT('0')
      ,i_Key_5                      VARCHAR(50)       DEFAULT('837P_Inbound')
      ,i_Key_6                      VARCHAR(80)       DEFAULT('0')
      ,i_key_7_field                VARCHAR(50)       DEFAULT('0')
      ,i_key_8_field                VARCHAR(80)       DEFAULT('0')
      ,i_key_9_field                VARCHAR(50)       DEFAULT('0')
      ,i_key_10_field               VARCHAR(50)       DEFAULT('0')
      ,iAction                      VARCHAR(50)       DEFAULT('ADD')
      ,i_date_time_modified         VARCHAR(50)       DEFAULT('')
      ,i_user_id                    VARCHAR(20)       DEFAULT('')
      ,i_Transaction_Type           VARCHAR(50)		  DEFAULT('837P')
...
--*************************************************************************************************
INSERT INTO #TradingPartnersInbound837Prof
      (SearchID
...
SELECT SearchID
      ...
      ,ISNULL(dbo.fnDCAuto_GetDropdownValue([ValidateReferringProviderMedicaidID]), 'N')
      ,ISNULL(dbo.fnDCAuto_GetDropdownValue([ValidateOrderingProviderMedicaidID]), 'N')
	  ,ISNULL([SequestrationAdjustmentID], '')
      ,ISNULL([RecordID], '')
      ,ISNULL([gid], '')
  FROM COREAUTO.CoreAutomation.dbo.TD_TradingPartnersInbound837Pro
...
-- Update the user
--*************************************************************************************************
UPDATE #TradingPartnersInbound837Prof
   SET i_user_id  = @user

--*************************************************************************************************
-- Create the data
--*************************************************************************************************
DECLARE TradingPartnersInbound837Prof_Cursor CURSOR FOR
 SELECT SearchID
       ,i_entity_name
       ...
       ,record_id
       ,static_gid
   FROM #TradingPartnersInbound837Prof

   OPEN TradingPartnersInbound837Prof_Cursor
  FETCH NEXT FROM TradingPartnersInbound837Prof_Cursor
   INTO @SearchID
       ,@i_entity_name
       ,@i_Trading_partner_gid
       ,@i_Key_Transaction_type
...
CLOSE TradingPartnersInbound837Prof_Cursor
DEALLOCATE TradingPartnersInbound837Prof_Cursor
