IF OBJECT_ID('dbo.spDCAuto_CreateNonPaymentParametersMember') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersMember AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDCAuto_CreateNonPaymentParametersMember
...
***************************************************************************************************
EXEC spDCAuto_CreateNonPaymentParametersMember '100-Config%', 22, 'NonPaymentParametersMember'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersMember
...
--*************************************************************************************************
IF OBJECT_ID('tempdb.dbo.#NonPaymentParametersMember') IS NOT NULL
	DROP TABLE #NonPaymentParametersMember

CREATE TABLE #NonPaymentParametersMember
      (SearchID                         VARCHAR(200)
      ...
      ,i_NPP_parameter_id               VARCHAR(100)
      ,i_NPP_parameter_description      VARCHAR(50)
      ,i_entityType                     VARCHAR(100)	  DEFAULT('M')
      ,i_invoiceFrequency               VARCHAR(50)
      ,i_delinquencyType                VARCHAR(75)
      ,i_NPP_category                   VARCHAR(50)
      ,i_Seq_Order                      VARCHAR(20)
...
--*************************************************************************************************
INSERT INTO #NonPaymentParametersMember
      (SearchID
      ,i_invoiceFrequency
      ,i_delinquencyType
      ,i_NPP_category
...
SELECT SearchID
      ...
      ,ISNULL([RecordID], '')
      ,ISNULL([gid], '')
  FROM COREAUTO.CoreAutomation.dbo.TD_NonPaymentParametersMember
...
-- Update the user
--*************************************************************************************************
UPDATE #NonPaymentParametersMember
   SET iUserID  = @user

--*************************************************************************************************
-- Create the data
--*************************************************************************************************
DECLARE NonPaymentParametersMember_Cursor CURSOR FOR
 SELECT SearchID
       ,i_Entity_name
       ,i_NPP_Parameter_Gid
       ,i_NPP_Parameter_sid
       ...
       ,record_id
       ,static_gid
   FROM #NonPaymentParametersMember

   OPEN NonPaymentParametersMember_Cursor
  FETCH NEXT FROM NonPaymentParametersMember_Cursor
   INTO @SearchID
       ,@i_Entity_name
       ,@i_NPP_Parameter_Gid
       ,@i_NPP_Parameter_sid
...
CLOSE NonPaymentParametersMember_Cursor
DEALLOCATE NonPaymentParametersMember_Cursor
