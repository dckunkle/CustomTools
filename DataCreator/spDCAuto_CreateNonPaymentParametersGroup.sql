IF OBJECT_ID('dbo.spDCAuto_CreateNonPaymentParametersGroup') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersGroup AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDCAuto_CreateNonPaymentParametersGroup
Purpose:    Create NonPaymentparametersgroup data from CorderAutomation
Method:     NonPaymentParametersGroup
Screen GID: 6097
...
***************************************************************************************************
EXEC spDCAuto_CreateNonPaymentParametersGroup '100-Config%', 22, 'NonPaymentParametersGroup'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersGroup
...
--*************************************************************************************************
IF OBJECT_ID('tempdb.dbo.#NonPaymentParametersGroup') IS NOT NULL
	DROP TABLE #NonPaymentParametersGroup

CREATE TABLE #NonPaymentParametersGroup
      (SearchID                         VARCHAR(200)
      ...
      ,i_NPP_parameter_id               VARCHAR(100)
      ,i_NPP_parameter_description      VARCHAR(50)
      ,i_entityType                     VARCHAR(100)	  DEFAULT('G')
      ,i_invoiceFrequency               VARCHAR(50)
      ,i_delinquencyType                VARCHAR(75)
      ,i_NPP_category                   VARCHAR(50)
      ,i_Seq_Order                      VARCHAR(20)
...
--*************************************************************************************************
INSERT INTO #NonPaymentParametersGroup
      (SearchID
      ,i_invoiceFrequency
      ,i_delinquencyType
      ,i_NPP_category
...
SELECT SearchID
      ...
      ,ISNULL([RecordID], '')
      ,ISNULL([gid], '')
  FROM COREAUTO.CoreAutomation.dbo.TD_NonPaymentParametersGroup
...
-- Update the user
--*************************************************************************************************
UPDATE #NonPaymentParametersGroup
   SET iUserID  = @user

--*************************************************************************************************
-- Create the data
--*************************************************************************************************
DECLARE NonPaymentParametersGroup_Cursor CURSOR FOR
 SELECT SearchID
       ,i_Entity_name
       ,i_NPP_Parameter_Gid
       ,i_NPP_Parameter_sid
       ...
       ,record_id
       ,static_gid
   FROM #NonPaymentParametersGroup

   OPEN NonPaymentParametersGroup_Cursor
  FETCH NEXT FROM NonPaymentParametersGroup_Cursor
   INTO @SearchID
       ,@i_Entity_name
       ,@i_NPP_Parameter_Gid
       ,@i_NPP_Parameter_sid
...
CLOSE NonPaymentParametersGroup_Cursor
DEALLOCATE NonPaymentParametersGroup_Cursor
