IF OBJECT_ID('dbo.spDCAuto_CreateNonPaymentParametersMemberInitial') IS NULL
    EXEC ('CREATE PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersMemberInitial AS SELECT 1')
GO
/**************************************************************************************************
Name:       spDCAuto_CreateNonPaymentParametersMemberInitial
Purpose:    Create NonPaymentparametersgroup data from CorderAutomation
Method:     NonPaymentParametersMemberInitial
Screen GID: 6097
...
***************************************************************************************************
EXEC spDCAuto_CreateNonPaymentParametersMemberInitial '100-Config%', 22, 'NonPaymentParametersMember'
***************************************************************************************************/
ALTER PROCEDURE dbo.spDCAuto_CreateNonPaymentParametersMemberInitial
...
--*************************************************************************************************
IF OBJECT_ID('tempdb.dbo.#NonPaymentParametersMemberInitial') IS NOT NULL
	DROP TABLE #NonPaymentParametersMemberInitial

CREATE TABLE #NonPaymentParametersMemberInitial
      (SearchID                         VARCHAR(200)
      ...
      ,i_NPP_parameter_id               VARCHAR(100)
      ,i_NPP_parameter_description      VARCHAR(50)
      ,i_entityType                     VARCHAR(100)	  DEFAULT('I')
      ,i_invoiceFrequency               VARCHAR(50)
      ,i_delinquencyType                VARCHAR(75)
      ,i_NPP_category                   VARCHAR(50)
      ,i_Seq_Order                      VARCHAR(20)
...
--*************************************************************************************************
INSERT INTO #NonPaymentParametersMemberInitial
      (SearchID
      ,i_invoiceFrequency
      ,i_delinquencyType
      ,i_NPP_category
...
SELECT SearchID
      ...
      ,ISNULL([RecordID], '')
      ,ISNULL([gid], '')
  FROM COREAUTO.CoreAutomation.dbo.TD_NonPaymentParametersMemberInitial
...
-- Update the user
--*************************************************************************************************
UPDATE #NonPaymentParametersMemberInitial
   SET iUserID  = @user

--*************************************************************************************************
-- Create the data
--*************************************************************************************************
DECLARE NonPaymentParametersMemberInitial_Cursor CURSOR FOR
 SELECT SearchID
       ,i_Entity_name
       ,i_NPP_Parameter_Gid
       ,i_NPP_Parameter_sid
       ...
       ,record_id
       ,static_gid
   FROM #NonPaymentParametersMemberInitial

   OPEN NonPaymentParametersMemberInitial_Cursor
  FETCH NEXT FROM NonPaymentParametersMemberInitial_Cursor
   INTO @SearchID
       ,@i_Entity_name
       ,@i_NPP_Parameter_Gid
       ,@i_NPP_Parameter_sid
...
CLOSE NonPaymentParametersMemberInitial_Cursor
DEALLOCATE NonPaymentParametersMemberInitial_Cursor
